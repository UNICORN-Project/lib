...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/SbContinuanceCancelInput.php');
	require_once( 'com/gmo_pg/client/tran/SbContinuanceCancel.php');
	
	//入力パラメータクラスをインスタンス化します
	$input = new SbContinuanceCancelInput();/* @var $input SbContinuanceCancelInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new SbContinuanceCancel();/* @var $exec SbContinuanceCancel */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output SbContinuanceCancelOutput */
...
//SbContinuanceCancel入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/SbContinuanceCancel.php' );