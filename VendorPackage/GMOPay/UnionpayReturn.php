...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/UnionpayReturnInput.php');
	require_once( 'com/gmo_pg/client/tran/UnionpayReturn.php');
	
	//入力パラメータクラスをインスタンス化します
	$input = new UnionpayReturnInput();/* @var $input UnionpayReturnInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new UnionpayReturn();/* @var $exec UnionpayReturn */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output UnionpayReturnOutput */
...
//UnionpayReturn入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/UnionpayReturn.php' );