...
if( isset( $_POST['submit'] ) ){
	...
	$input = new ExecTranDocomoInput();/* @var $input ExecTranDocomoInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new ExecTranDocomo();/* @var $exec ExecTranDocomo */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output ExecTranDocomoOutput */
...
require_once( PGCARD_SAMPLE_BASE . '/display/ExecTranDocomo.php' );