 ...
 */
class FletsCancelOutput extends BaseOutput {
	 ...
	 */
	function FletsCancelOutput($params = null) {
	...
	function __construct($params = null) {
		...
		$this->setCenterExecTime($params->get('CenterExecTime'));
	...
	/**
	 * センター処理日時取得
	 * @return string センター処理日時
	 */
	function getCenterExecTime() {
		return $this->centerExecTime;
	}
	/**
	 * 処理日時取得
	 * @return string 処理日時
	 ...
	 * センター処理日時設定
	 *
	 * @param string $centerExecTime
	 */
	function setCenterExecTime($centerExecTime) {
		$this->centerExecTime = $centerExecTime;
	}
	/**
	 * 処理日時設定
	 *
	...
	function toString() {
		...
		$str .='&';
		$str .= 'CenterExecTime=' . $this->encodeStr($this->getCenterExecTime());
		$str .='&';
