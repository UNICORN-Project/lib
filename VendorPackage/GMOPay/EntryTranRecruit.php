...
if( isset( $_POST['submit'] ) ){
	...
	$input = new EntryTranRecruitInput();/* @var $input EntryTranRecruitInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryTranRecruit();/* @var $exec EntryTranRecruit */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output EntryTranRecruitOutput */
...
//EntryTranRecruit入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryTranRecruit.php' );