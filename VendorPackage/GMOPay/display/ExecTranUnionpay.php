...
<head>
	...
	<title>[ExecTranUnionpay]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>ネット銀聯決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="CommodityName" type="text" size="27" tabindex="16" /></td>
			</tr>
			<tr>
				<th scope="row">加盟店自由項目1(ClientField1)</th>
				<td><input name="ClientField1" type="text" size="27" tabindex="17" /></td>
			</tr>
			<tr>
				<th scope="row">加盟店自由項目2(ClientField2)</th>
				<td><input name="ClientField2" type="text" size="27" tabindex="18" /></td>
			</tr>
			<tr>
				<th scope="row">加盟店自由項目3(ClientField3)</th>
				<td><input name="ClientField3" type="text" size="27" tabindex="19" /></td>
			</tr>
			<tr>
				<th scope="row">加盟店自由項目返却フラグ(ClientFieldFlag)</th>
				<td><input name="ClientFieldFlag" type="text" size="27" tabindex="20" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input name="ErrorRcvURL" type="text" size="27" tabindex="22" /></td>
			</tr>
