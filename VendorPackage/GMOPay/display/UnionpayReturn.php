...
<head>
	...
	<title>[UnionpayReturn]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>ネット銀聯返品/モジュールタイプ(PHP) 呼び出しサンプル</h1>
...
<div id="main">
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				<th scope="row">返品金額(CancelAmount)</th>
				<td><input name="CancelAmount" type="text" size="10" tabindex="16" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">返品税送料(CancelTax)</th>
				<td><input name="CancelTax" type="text" size="10" tabindex="17" class="num" /></td>
			</tr>
