...
<head>
	...
	<title>[RakutenIdChange]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>楽天ID金額変更/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="Tax" type="text" size="10" tabindex="17" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">クーポン使用フラグ(UseCoupon)</th>
				<td><input name="UseCoupon" type="text" size="27" tabindex="18" /></td>
			</tr>
