...
<div id="header">
	<h1>楽天ID登録・決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
...
<div id="main">
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				<th scope="row">サブ商品ID(ItemSubId)</th>
				<td><input name="ItemSubId" type="text" size="27" tabindex="23" /></td>
			</tr>
			<tr>
				<th scope="row">商品名(ItemName)</th>
				<td><input name="ItemName" type="text" size="27" tabindex="24" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input name="PaymentTermSec" type="text" size="10" tabindex="27" class="num" /></td>
			</tr>
