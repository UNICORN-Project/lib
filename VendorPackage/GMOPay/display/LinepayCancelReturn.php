...
<head>
	...
	<title>[LinepayCancelReturn]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>LINE Payキャンセル・返品/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="CancelAmount" type="text" size="10" tabindex="15" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">キャンセル税送料(CancelTax)</th>
				<td><input name="CancelTax" type="text" size="10" tabindex="16" class="num" /></td>
			</tr>
