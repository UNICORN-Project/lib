...
if( isset( $_POST['submit'] ) ){
	...
	$input = new EntryTranSbContinuanceInput();/* @var $input EntryTranSbContinuanceInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryTranSbContinuance();/* @var $exec EntryTranSbContinuance */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output EntryTranSbContinuanceOutput */
...
//EntryTranSbContinuance入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryTranSbContinuance.php' );