...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/DeleteLinepayRegKeyInput.php');
	require_once( 'com/gmo_pg/client/tran/DeleteLinepayRegKey.php');
	
	//入力パラメータクラスをインスタンス化します
	$input = new DeleteLinepayRegKeyInput();/* @var $input DeleteLinepayRegKeyInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new DeleteLinepayRegKey();/* @var $exec DeleteLinepayRegKey */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output DeleteLinepayRegKeyOutput */
...
//DeleteLinepayRegKey入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/DeleteLinepayRegKey.php' );