...
if( isset( $_POST['submit'] ) ){
	...
	$input = new ExecTranRecruitInput();/* @var $input ExecTranRecruitInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new ExecTranRecruit();/* @var $exec ExecTranRecruit */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output ExecTranRecruitOutput */
...
//ExecTranRecruit入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/ExecTranRecruit.php' );