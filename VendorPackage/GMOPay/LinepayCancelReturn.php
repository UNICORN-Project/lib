...
if( isset( $_POST['submit'] ) ){
	...
	$input = new LinepayCancelReturnInput();/* @var $input LinepayCancelReturnInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new LinepayCancelReturn();/* @var $exec LinepayCancelReturn */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output LinepayCancelReturnOutput */
...
//LinepayCancelReturn入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/LinepayCancelReturn.php' );