...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/CheckLinepayRegKeyInput.php');
	require_once( 'com/gmo_pg/client/tran/CheckLinepayRegKey.php');
	
	//入力パラメータクラスをインスタンス化します
	$input = new CheckLinepayRegKeyInput();/* @var $input CheckLinepayRegKeyInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new CheckLinepayRegKey();/* @var $exec CheckLinepayRegKey */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output CheckLinepayRegKeyOutput */
...
//CheckLinepayRegKey入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/CheckLinepayRegKey.php' );