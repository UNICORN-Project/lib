...
if( isset( $_POST['submit'] ) ){
	...
	require_once( 'com/gmo_pg/client/input/EntryExecTranRakutenIdInput.php');
	require_once( 'com/gmo_pg/client/tran/EntryExecTranRakutenId.php');
	
	//入力パラメータクラスをインスタンス化します
	$input = new EntryExecTranRakutenIdInput();/* @var $input EntryExecTranRakutenIdInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryExecTranRakutenId();/* @var $exec EntryExecTranRakutenId */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼びます。
	//正常に終了した場合、結果オブジェクトが返るはずです。
	$output = $exe->exec( $input );/* @var $output EntryExecTranRakutenIdOutput */
...
//EntryExecTranRakutenId入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryExecTranRakutenId.php' );