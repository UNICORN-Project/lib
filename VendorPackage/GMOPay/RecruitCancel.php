...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/RecruitCancelInput.php');
	require_once( 'com/gmo_pg/client/tran/RecruitCancel.php');
	
	//入力パラメータクラスをインスタンス化します
	$input = new RecruitCancelInput();/* @var $input RecruitCancelInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new RecruitCancel();/* @var $exec RecruitCancel */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output RecruitCancelOutput */
...
//RecruitCancel入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/RecruitCancel.php' );