...
public class Log {
	...
	private static final String TAG = "GMATCH";
	private static final boolean IS_PRINT_DEBUG = false;
	private static final boolean IS_PRINT_WARNNING = false;
	private static final boolean IS_PRINT_ERROR = false;
	private static final boolean IS_PRINT_INFO = false;
	private static final boolean IS_PRINT_VERBOSE = false;
	private static final boolean IS_PRINT_CLASS_AND_METHOD = false;
