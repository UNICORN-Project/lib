...
$defaultPort = ((isset($_SERVER["HTTPS"]) && "on" == $_SERVER["HTTPS"]) ? "https" : "http");
// testerプログラムのURL(絶対パスで指定)
$baseTesterPHPURLs = array();
$baseTesterPHPURLs[] = $defaultPort."://".$_SERVER["SERVER_NAME"].dirname($_SERVER["REQUEST_URI"])."/tester.php";
// testerプログラムのURL(絶対パスで指定)
$baseTargetServerHosts = array();
$baseTargetServerHosts[] = (0 === strpos($_SERVER["SERVER_NAME"], "fwm")) ? substr($_SERVER["SERVER_NAME"], 3) : $_SERVER["SERVER_NAME"];
// テストするAPIのサブURL
$apis = array();
$apis[] = "api/user.json";
$apis[] = "api/me/user.json";
			...
			<div id="formView">
				...
				<div class="formLine" id="protocol">
					...
					<select class="formParts" name="protocol">
						<option value="http"<?php echo ("http" == $defaultPort)?" selected=\"selected\"":""; ?>>http</option>
						<option value="https"<?php echo ("https" == $defaultPort)?" selected=\"selected\"":""; ?>>https</option>
					</select>
				...
				<div class="formLine" id="multiParam">
					...
					<div id="multiParamBlock1" class="multiParamBlock">
						...
						<div class="multiParamLine multiParamKey">
							...
							<input type="text" name="key[num1]" value="limit" />
						</div>
						<div class="multiParamLine multiParamVal">
							<div class="label">value</div>
							<input type="text" name="val[num1]" value="10" />
						</div>
