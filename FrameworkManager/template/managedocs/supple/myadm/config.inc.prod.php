...
$i++;
$cfg['Servers'][$i]['host']          = 'production-rdscluster-jcbnxit819wk.cluster-ce4oivfp6jap.ap-northeast-1.rds.amazonaws.com'; // MySQL hostname or IP address
...
$cfg['Servers'][$i]['verbose']       = 'anlimited';          // Verbose name for this host - leave blank to show the hostname
