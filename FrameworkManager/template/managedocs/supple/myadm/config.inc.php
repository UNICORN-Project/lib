...
$cfg['Servers'][$i]['controlpass']   = '';          // access to the "mysql/user"
                                                    ...
                                                    // features (pmadb)
$cfg['Servers'][$i]['auth_type']     = 'signon';    // Authentication method (config, http or cookie based)?
$cfg['Servers'][$i]['SignonURL'] = '../../fwm-pma-auth.html';
$cfg['Servers'][$i]['SignonSession'] = 'fwm_pma_refresh_token';
$cfg['Servers'][$i]['user']          = 'hoge';      // MySQL user
$cfg['Servers'][$i]['password']      = 'fuga';          // MySQL password (only needed
