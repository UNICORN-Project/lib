...
$i++;
$cfg['Servers'][$i]['host']          = 'development-rdscluster-fnvsw89oii74.cluster-ce4oivfp6jap.ap-northeast-1.rds.amazonaws.com'; // MySQL hostname or IP address
...
$cfg['Servers'][$i]['user']          = 'anlimiteduser';      // MySQL user
$cfg['Servers'][$i]['password']      = 'anlimitedpass';      // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = '';          // If set to a db-name, only
                                                    // this db is displayed in left frame
                                                    // It may also be an array of db-names, where sorting order is relevant.
$cfg['Servers'][$i]['verbose']       = 'anlimiteddev';          // Verbose name for this host - leave blank to show the hostname
